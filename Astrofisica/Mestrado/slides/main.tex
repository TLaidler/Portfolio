...
\definecolor{corPrim}{RGB}{58,28,96}    % roxo escuro (estrutura)
...
% --- Callout: número grande de RESULTADO (vermelho) + legenda curta ---
\newcommand{\bignum}[2]{%
  {\centering
   {\fontsize{40}{44}\selectfont\color{corRes}\textbf{#1}}\\[0.25em]
   {\small #2}\par}}
...
\date{Julho de 2026}
\titlegraphic{\hfill\includegraphics[height=1.3cm]{on_logo.png}}
...
\begin{frame}{O conjunto de dados}
  \begin{columns}[c]
    ...
    \bignum{1693}{curvas de luz\\(802 positivas / 891 negativas)}

...
Este capítulo situou as ocultações estelares como fenômeno astronômico e as curvas de luz como produto observacional central. Destacamos o papel da geometria da sombra, das cordas e da precisão astrométrica na previsão e no aproveitamento dos eventos; a coleta e o armazenamento dos dados foram descritos em linhas gerais; e foram resumidas as características observacionais das curvas. O volume crescente de dados produzidos por redes de telescópios e catálogos como o Gaia torna penosa a triagem manual de todas as curvas de luz; essa escala motiva o desenvolvimento de métodos automatizados de detecção baseados em aprendizado de máquina, cujos fundamentos são apresentados no Capítulo~3 e cuja implementação é detalhada no Capítulo~4. Notadamente, nos interessam também que sejam apontados eventos tênues e que passaram despercebidos num primeiro tratamento de curvas de luz - como ocorreu, por exemplo, na descoberta dos anéis de Quaoar, descrito em \citep{Quaoar2023}. Um alerta confiável nesses casos é suporte para campanhas observacionais e descobertas importantes.

...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\linewidth]{pngs/curva.png}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[b]{0.48\textwidth}
        ...
        \centerline{\small (d)}
    \end{minipage}
    \caption{Exemplo completo do fluxo observacional: ocultação estelar por Umbriel (satélite de Urano), observada em 21 de setembro de 2020 \citep{Umbriel2020}. (a)~Mapa de previsão da sombra sobre a superfície terrestre. (b)~Detalhe do posicionamento dos observadores na costa leste dos EUA (Google Earth). (c)~Quadros CCD de uma das estações: antes, durante e após a ocultação; note o brilho de Urano dificultando a fotometria. (d)~Curva de luz resultante da redução via PRAIA: fluxo normalizado de Umbriel (azul) e ruído de fundo (verde), com a queda de ocultação claramente visível.}

...
\end{figure} %% CORREÇÃO: NÃO É CHAMADA NO TEXTO
...
%% CORREÇÃO: O tempo morto entre frames não entra nessa discussão sobre resolução? 
...
\end{figure} %% CORREÇÃO: NÃO É CHAMADA NO TEXTO E SOA UMA CHAMADA UM POUCO PERDIDA NO CONTEXTO
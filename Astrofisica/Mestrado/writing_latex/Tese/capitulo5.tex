...
% TODO (autor): regenerar as figuras do Experimento 3 (matrizes de confusão e ROC) com
% TEST_SIZE = 0.20 e TEST_ON_REAL_ONLY = True em train_model.py. As figuras da variante
% 65/35 foram movidas para o Apêndice (fig:confusao_7 e fig:ROC7).

...
\begin{itemize}
	...
	\item \textbf{Aplicação a campanhas específicas:} ampliar o estudo de caso conduzido sobre a ocultação por Quaoar (Seção~\ref{sec:estudo_caso_quaoar}) a outras campanhas observacionais e a um número maior de eventos por objeto, em cenário real de uso integrado ao SORA.

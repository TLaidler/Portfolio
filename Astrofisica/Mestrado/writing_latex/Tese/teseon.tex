...
% --- REVISÃO DE ESTILO: marcação de trechos com "cara de IA" ---
% Trechos pintados de vermelho com \ia{...} são candidatos a reescrita manual
% (recap simétrico, conectivo de preenchimento, repetição, voz genérica).
% Depois de revisar, basta apagar o \ia{ } ao redor ou redefinir abaixo como
% \newcommand{\ia}[1]{#1} para "desligar" todas as marcações de uma vez.
\newcommand{\ia}[1]{\textcolor{red}{#1}}

...
# Cria uma janela
janela = tk.Tk()
janela.title("Hutake - Análise automática de FIIs")
# Cria um rótulo com o nome do programa
label_titulo = tk.Label(janela, text="Hutake - Análise FIIs")
label_titulo.pack()
# Cria um botão "Analisar"
botao_analisar = tk.Button(janela, text="Analisar", command=botao_analisar)
botao_analisar.pack()
# Inicia o loop principal da janela
janela.mainloop()

def realizar_analise():
    messagebox.showinfo("Análise Concluída", "A análise foi concluída com sucesso!") # Função para chamar quando o botão "Analisar" for pressionado
